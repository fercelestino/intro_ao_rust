...
fn execute() {
    let funcionario1 = Pessoa::new("Fulano".to_string(), 30, 1000.0);
    let funcionario2 = Pessoa::new("Sicrano".to_string(), 30, 1000.0);
...
pub fn da_aumento(pessoa: &mut Pessoa, valor: f64) {
